...
<?php
	...
	if(isset($_POST["DAF"]) && ($_POST["DAF"] == "LAW"))
	{
		...
		//SQL query command
		$sql="INSERT INTO LAWATAN (NAMA, ALAMAT, NEGERI, SEKTOR, INDUS, PEGAWAI) VALUES (\"$NAMA\", \"$ALAMAT\", \"$NEGERI\", \"$SEKTOR\", \"$INDUS\", \"$PEGAWAI\") ";
		...
		if ($exe_sql)
		{
			echo '<html>
					<head>
						<script>
							window.alert("Pendaftaran data bagi lawatan berjaya!");
						</script>
						<meta http-equiv="refresh" content="0; url=pendaftaran.php?DAF=law" />
					</head>
				</html>';
		}
		else
		{
			...
			echo '<html>
					<head>
						<script>
							window.alert("Pendaftaran data bagi lawatan gagal!");
							window.history.go(-1);
						</script>
					</head>
				</html>';
	...
	if(isset($_POST["DAF"]) && ($_POST["DAF"] == "BEN"))
	{
		// Variables from pendaftaran.php
		$NAMA		= mysql_real_escape_string($_POST['NAMA']);
		$ALAMAT		= mysql_real_escape_string($_POST['ALAMAT']);
		...
		//SQL query command
		$sql="INSERT INTO BENGKEL (NAMA, ALAMAT, NEGERI, SEKTOR, INDUS, PENCERAMAH, JAWATAN, KELAYAKAN, KEMAHIRAN) VALUES (\"$NAMA\", \"$ALAMAT\", \"$NEGERI\", \"$SEKTOR\", \"$INDUS\", \"$PENCERAMAH\", \"$JAWATAN\", \"$KELAYAKAN\", \"$KEMAHIRAN\")";
		...
		if ($exe_sql)
		{
			echo '<html>
					<head>
						<script>
							window.alert("Pendaftaran data bagi penceramah berjaya!");
						</script>
						<meta http-equiv="refresh" content="0; url=pendaftaran.php?DAF=ben" />
					</head>
				</html>';
		}
		else
		{
			...
			echo '<html>
					<head>
						<script>
							window.alert("Pendaftaran data bagi penceramah gagal!");
							window.history.go(-1);
						</script>
					</head>
				</html>';
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="pendaftaran.php">Tambah Data</a>
                </div>
...
?>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Daftar Data Baru</h4>
                                <p class="category">Sila pilih kategori berkaitan.</p>
                            </div>
                            <div class="content">
								<center>
									<a href="pendaftaran.php?DAF=law"><button class="btn btn-fill btn-info">Lawatan</button></a>
									<a href="pendaftaran.php?DAF=ben"><button class="btn btn-fill btn-warning">Penceramah</button></a>
								</center>
                            </div>
                        </div>
                    </div>
<?php
	...
	if(isset($_GET["DAF"]) && ($_GET["DAF"] == "law"))
	{
?>
					<div class="col-md-10">
                        <div class="card">
                            ...
                            <div class="content">
								<form id="LAW" action="pendaftaran.php" method="POST">
									<input type="hidden" name="DAF" value="LAW">
                                    <div class="row">
                                        <div class="col-md-8">
...
?>
                                    ...
                                    <button form="LAW" type="submit" class="btn btn-success btn-fill pull-left">Daftar</button>
...
<?php
	...
	if(isset($_GET["DAF"]) && ($_GET["DAF"] == "ben"))
	{
?>
					<div class="col-md-10">
                        <div class="card">
                            ...
                            <div class="content">
								<form id="BEN" action="pendaftaran.php" method="POST">
									<input type="hidden" name="DAF" value="BEN">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Nama Organisasi</label>
