...
<?php
	...
	// Pinda lawatan
		if(isset($_POST['PIN']))
		{
			...
			$sql="UPDATE LAWATAN SET NAMA = '$NAMA', ALAMAT = '$ALAMAT', NEGERI = '$NEGERI', SEKTOR = '$SEKTOR', INDUS = '$INDUS', PEGAWAI = '$PEGAWAI' WHERE ID_LAW = $ID_PIN";
			...
			if ($exe_sql)
			{
				echo '<html>
						<head>
							<script>
								window.alert("Pindaan data lawatan berjaya!");
							</script>
			...
			else
			{
				...
				echo '<html>
						<head>
							<script>
								window.alert("Pindaan data lawatan gagal!");
								window.history.go(-1);
							</script>
						</head>
					</html>';
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="pinda_law.php">Pinda Data</a>
                </div>
...
<?php
	if(isset($_GET["ID"]))
	{
		...
		$sql	= "SELECT * FROM LAWATAN WHERE ID_LAW = $ID";
...
?>
					<div class="col-md-10">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Pinda Data Lawatan</h4>
                            </div>
                            <div class="content">
								<form id="LAW" action="pinda_law.php" method="POST">
									<input type="hidden" name="PIN" value="<?php echo $ID_LAW; ?>">
                                    <div class="row">
                                        <div class="col-md-8">
									...
									<div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
												...
												<textarea rows="5" class="form-control" name="PEGAWAI"><?php echo $PEGAWAI; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
